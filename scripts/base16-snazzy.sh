...
# Based on Hyper Snazzy scheme by Sindre Sorhus (sindresorhus.com)
...
color15="ef/f0/eb" # Base 07 - Bright White
...
color_foreground="f1/f1/f0" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg f1f1f0 # foreground
  printf $printf_template_custom Ph 282a36 # background
  printf $printf_template_custom Pi f1f1f0 # bold color
  printf $printf_template_custom Pj 373b41 # selection color
  printf $printf_template_custom Pk f1f1f0 # selected text color
  printf $printf_template_custom Pl f1f1f0 # cursor
